...
<body>
        ...
        <div class="container">
            <div class="nav-wrapper">
                ...
                <div class="dashboard-nav">
                    ...
                    <span class="welcome-text">Welcome back, <?php echo htmlspecialchars($user['name']); ?>!</span>
                    <button class="theme-toggle" id="themeToggle">
                        <i class="fas fa-sun sun-icon"></i>
                        <i class="fas fa-moon moon-icon"></i>
                    </button>
                    <div class="user-menu">
                        <button class="btn btn-outline btn-small" onclick="toggleUserMenu()">
    ...
    <main class="dashboard">
        <div class="container">
            ...
            <div class="welcome-banner" id="welcomeBanner">
                <div class="welcome-content">
                    ...
                    <div class="welcome-text-content">
                        <h3>Welcome to Focus, <?php echo htmlspecialchars($user['name']); ?>!</h3>
            ...
            <!-- Rest of the dashboard content remains the same as dashboard.html -->
            <!-- Tabs -->
            <div class="tabs">
                <div class="tab-list">
                ...
                <!-- Other tabs remain the same as dashboard.html -->
                <!-- Notes Tab -->
